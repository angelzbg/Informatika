...
public class ModelExtra1 extends AbstractTableModel {
	...
	private ArrayList<Object> data=new ArrayList<Object>();
	 ...
	 public ModelExtra1(ResultSet rs) throws Exception
	 {
		 setRS(rs);
	 }// end constructor
	 ...
	 public String getColumnName(int columnIndex){
		 switch (columnIndex) {
			...
			case 2: return "ISBN";
			case 3: return "Наличен брой";
			case 4:	return "Единична цена";
		}
	 }// end getColumnName
}